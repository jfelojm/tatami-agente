 ...
 * tatami_staging.gs
 * ──────────────────
 * Script unificado para el Sheets de Staging (Masters Sheets).
 * Menú Tatami Admin (promoción) y Tatami Tests (pruebas).
 *
 * INSTALACIÓN:
 ...
 *
 * Subrecetas: STAGING_SUB_CAB + STAGING_SUB_DETALLE → BD_SUBRECETAS*
 * Recetas v2: STAGING_RECETAS (tipo_linea MP|SUB) → BD_RECETAS_DETALLE
 */
