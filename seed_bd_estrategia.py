...
BD_CONFIG_ROWS: list[list[str]] = [
    ...
    ["perm_conteo_iniciar_roles", "ADMIN,JEFE_BARRA,JEFE_COCINA,STAFF_COCINA,STAFF_BARRA,ADMIN_COMPRAS", "INICIAR CONTEO", "csv"],
    ...
    ["perm_conteo_bodegas_STAFF_BARRA", "BOD-002,BOD-003", "Bodegas Cristian/staff barra", "csv"],
    ...
    ["perm_producir_sub_bodegas_STAFF_COCINA", "BOD-001,BOD-005", "Staff cocina batches (restaurante + externa)", "csv"],
    [
...
def _build_estrategia_matrix() -> list[list[str]]:
    ...
    perm_rows = [
        ...
        ["Iniciar conteo", "SI", "NO", "SI", "SI", "SI", "SI", "NO", "NO", ""],
